...
{
    internal sealed class StatConverter_IdentifyByProtocolVersion : JsonCreationConverter<Stat>
    {
        private readonly int _protocolVersion;

        public StatConverter_IdentifyByProtocolVersion(int protocolVersion)
        {
